...
if DB_TYPE == "sqlite":
    # ----------------------------------------
    # SQLITE ADAPTER (Dev Mode)
    # ----------------------------------------
    print(">>> ⚠️  USING SQLITE ADAPTER (Dev Mode) ⚠️")
    from backend.database_sqlite import get_db as sqlite_get_db, init_db as sqlite_init_db, hash_pass, verify_pass
